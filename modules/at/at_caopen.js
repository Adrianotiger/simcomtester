let AT_CAOPEN = new class extends ATBase
{  
  #cid = 0;
  #result = 0;
  ...
  constructor()
  {
    ...
    super({
      ...
      exe: true,
      test: true,
      description: "Open a TCP/UDP Connection",
      example: "AT+CAOPEN:(0-12),(0-4),(\"TCP\",\"UDP\",\"NONIP\"),64,(1-65535),(0,1)",
      cmd: "AT+CAOPEN",
      doc: "12.2.3"
    });
    ...
    enumConn.push(new ATEnum("NONIP", "NONIP"));
    ...
    this.AddParam("server", "string", "Server name or IP");
    this.AddParam("len_server", "number", "Max server name length");
    ...
    this.AddWriteSendParam({cid:null, pdp_index:null, conn_type:null, server:null, port:null, recv_mode:null});
    this.AddWriteSendParam({cid:null, pdp_index:null, conn_type:null, server:null, port:null});
        
    this.AddWriteAnswerParam({cid:null, result:null});

    this.AddReadAnswerParam({cid:null, pdp_index:null, conn_type:null, server:null, port:null});
  }
